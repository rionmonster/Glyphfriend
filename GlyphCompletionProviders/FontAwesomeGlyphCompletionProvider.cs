		...
		public ImageSource GetCompletionGlyph(string entryName, Uri sourceUri, CssNameType nameType)
		{
            ...
            if (_regex.IsMatch(filename))
            {
                try
                {
                    ...
                    return BitmapFrame.Create(new Uri(String.Format("pack://application:,,,/Glyphfriend;component/Glyphs/FontAwesome/{0}.png", entryName.Substring(10)), UriKind.RelativeOrAbsolute));
                }
                catch
                {
